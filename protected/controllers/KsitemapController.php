...
{
    public $protectedControllers = array('ksitemap','admin','guide','trainerDetails','userDetails','userMeasurements','users','userWorkouts','fbUser');   //controller array will not added in sitemap.xml
    public $protectedActions =array('site/guide','site/login','site/subscribe','site/index','site/s','site/error','site/logout','site/forgotpass','site/userLogin','site/activate','site/fblogin','site/userregister','site/dynamicstates','site/workouts','site/working','site/foddies','site/fooditems','site/dynamicStreet');      //controller/action array will not added in sitemap.xml
    public $priority = '0.5';                           //default priority for all url
    public $changefreq = 'daily';                       //default frequency for all url
    public $lastmod = '2013-10-08';                     //default last modified date
