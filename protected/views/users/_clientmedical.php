...
<ul class="login medical">
              <li>
                ...
                <p><span>1</span>Have you ever been diagnosed with a heart condition or feel pain in your chest when you do physical activity?</p>
                 <?php echo TbHtml::radioButtonList('heart',$cals[0],array('heart_diagnosed_chest_pain'=>'Yes','no_heart_diagnosed_chest_pains'=>'No'),array('disabled'=>'true','separator'=>'')); ?>
                
             </li>
              <li>
                <p><span>2</span> Do you feel dizzy while exercising, running, jogging or walking ?</p>
                <?php echo TbHtml::radioButtonList('passed',$cals[1],array('passed_out'=>'Yes','no_passed_out'=>'No'),array('disabled'=>'true','separator'=>'')); ?>
                
              </li>
              <li>
                <p><span>3</span>Have you had a recent hip, knee or any other replacement surgery?</p>
                <?php echo TbHtml::radioButtonList('surgery',$cals[2],array('replacement_surgery'=>'Yes','no_replacement_surgery'=>'No'),array('disabled'=>'true','separator'=>'')); ?>
              </li>
              <li>
                <p><span>4</span>Are you on medication for diabetes, hypertension or heart ailment ?</p>
                <?php echo TbHtml::radioButtonList('drugs',$cals[3],array('prescribed_drugs'=>'Yes','no_prescribed_drugs'=>'No'),array('disabled'=>'true','separator'=>'')); ?>
              </li>
              <li>
                <p><span>5</span>Are you pregnant, think you might be pregnant or have you given birth to a baby less than 6 weeks ago?</p>
                <?php echo TbHtml::radioButtonList('preg',$cals[4],array('pregnant'=>'Yes','no_pregnant'=>'No'),array('disabled'=>'true','separator'=>'')); ?>
              </li>
              <li>
                ...
                <?php echo TbHtml::radioButtonList('injured',$cals[5],array('injuries'=>'Yes','no_injuries'=>'No'),array('disabled'=>'true','separator'=>'')); ?>
