...
'id' => 'edit-workout',
'header' => '<h3>Edit Workout</h3>',
'content'=> $this->renderPartial('_editworkout',array('workout'=>$workout),true),//'adasdasdasd',//
...
//    'backdrop'=>false,
    'keyboard'=>TRUE,
     ...
     'htmlOptions'=>array('class'=>'modal hide fade workout-modal',
//         'style'=>'z-index:9999'
         ),
'footer' => array(

TbHtml::Button('Cancel',array('data-dismiss' => 'modal','id'=>'cancelprofilepop')),
TbHtml::submitButton('Update', array('id'=>'workedit', 'color' => TbHtml::BUTTON_COLOR_PRIMARY)),
),
)); ?>
