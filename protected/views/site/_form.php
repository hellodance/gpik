...
<div class="form">
 ...
 <ul class="login">
    <?php echo $form->errorSummary($model); ?>
            ...
            <div class="profess" style="float: left;width: 75%;">
                   <?php echo TbHtml::checkBox('istrainer', false, array('label' => 'Are you  a Fitness Professional?','labelOptions'=>array('style'=>''))); ?>
                   <?php // echo TbHtml::radioButton('istrainer',false,array('label'=>'Are you a Healthcare Professional?')); ?>
                   <?php echo TbHtml::dropDownList( 'type_id','',  TrainerType::model()->getTrainerTypeDropDown(), array('label' => ' ','style'=>'display:none;width:50%!important;margin-bottom:0px;','class'=>'inlinesdrop'));  ?>
            </div>
            ...
            <div class="column2" style  ="width: 25%;margin-top: 5px;margin-bottom: 4px;">
...
<script>
    $(document).ready(function(){
        ...
        $('#istrainer').click(function () {
                $("#type_id").toggle(this.checked);
            });
});
</script>