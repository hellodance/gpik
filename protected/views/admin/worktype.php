...
$this->widget('bootstrap.widgets.TbModal', array(
    ...
    'content' =>  $this->renderPartial('_worktypeform', array('model'=>$model),true),
    'footer' => array(
...
<?php $this->widget('yiiwheels.widgets.grid.WhGridView',array(
	...
	'columns'=>array(
		...
		array(
                        ...
                        'toggleAction'=>'admin/worktypetoggle', // contoller/action
                ...
                array(
                      'header' => 'Action',
                           ...
                           'buttons' => array('delete' =>array(
                                    'url' => 'Yii::app()->controller->createUrl("admin/Deleteworktype",array("id"=>$data->primaryKey))',
                                    'label' => 'delete',
                                ...
                                'update'=>array(
                                    'url' => 'Yii::app()->controller->createUrl("admin/Updateworktype",array("id"=>$data->primaryKey))',
                                    'label' => 'update',
                                    //'imageUrl'=>Yii::app()->request->baseUrl.'/images/glyphicons-halflings.png',
                                    'options' => array(// this is the 'html' array but we specify the 'ajax' element
                                        //'confirm' => 'are you sure?',
