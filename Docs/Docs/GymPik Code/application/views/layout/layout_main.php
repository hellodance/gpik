...
@import url("<?php echo base_url();?>css/js-image-slider.css");
</style>
...
<script src="<?php echo base_url();?>js/js-image-slider.js"></script>
<script>
...
<div id="wrapper">
	<div id="header">
    	<strong>
		<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>images/logo_trans.png" width="189" height="63" alt="" /></a></strong>
        <div class="top-nav">
        	<ul>
...
<?php if(isset($this->site_santry->get_auth_data()->id) && $this->site_santry->get_auth_data()->id != ''){?>
		...
		<div class="user-area">
			...
			<?php }else{?>
				<a href="<?php echo base_url();?>trainer/dashboard" class="signin"><span>My account</span></a>
			<?php }?>
...
<?php }?>
  ...
  <div id="banner">
 	<div id="sliderFrame">
        <div id="slider">
            <img src="<?php echo base_url();?>images/banners/banner1.png" alt="" />
            <img src="<?php echo base_url();?>images/banners/banner2.png" alt="" />
			<img src="<?php echo base_url();?>images/banners/banner3.png" alt="" />
			<img src="<?php echo base_url();?>images/banners/banner4.png" alt="" />
        </div>
    </div>
  </div>
  <div id="container">
