...
<table width="100%" border="0" cellspacing="16" cellpadding="0">
  <tr>
	...
	<?php echo form_open('trainer/register' ,$attributes); ?>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="40" align="center" valign="top" class="popupTitle">New Trainer Registration 
		<a href="#" id="close_x" class="close"><img src="images/close-icon.png" width="20" height="20" alt="" /></a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="left" style="padding-left:30px" valign="top">
         	<input type="text" placeholder="First Name" class="input-box" name="fname" id="fname" />
			</td>
      </tr>
      <tr>
        <td height="12" align="center" valign="top"><img src="images/spacer.png" width="12" height="12" alt="" /></td>
      </tr>
      <tr>
        <td align="left" style="padding-left:30px" valign="top">
			<input class="input-box" placeholder="Last Name" type="text" name="lname" id="lname" />
			</td>
      </tr>
      <tr>
        <td align="center" valign="top"><img src="images/spacer.png" width="12" height="12" alt="" /></td>
      </tr>
      <tr>
        <td align="left" style="padding-left:30px" valign="top">
	 ...
	 <tr>
      ...
      <tr>
        <td align="center" valign="top"><table width="86%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="25%" align="left" valign="middle">Speciality </td>
            <td width="72%" align="left" valign="middle">
				<div class="type">
             	<select style="z-index: 10; opacity: 0;" class="select" title="Select one" name="speciality" id="speciality">
      ...
      <tr>
        <td height="25" align="center" valign="top"><img src="images/spacer.png" width="18" height="10" alt="" /></td>
      </tr>
      <tr>
